...
class BottomnavigationBarMyWidget  extends StatefulWidget {
   BottomnavigationBarMyWidget ({super.key});

   @override
  State<BottomnavigationBarMyWidget> createState() => _NavigationBottomCuyState();
}

class _NavigationBottomCuyState extends State<BottomnavigationBarMyWidget> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
       appBar: AppBar(
        title: const Text('BottomnavigationBarMyWidget '),
      ),
